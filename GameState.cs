...
namespace BurglarOfBabylon
{
    public class GameState
    {
        ...
        public GameState()
        {
            ...
            {
                Player,
                new Actor("Third random guard", (31, 50), new GameTile(CP437Glyph.CapitalA, RogueColor.Magenta), Direction.North, new PatrolBrain((31, 50), (51, 30)), ActorRole.Guard),
                new Actor("Fourth random guard", (22, 10), new GameTile(CP437Glyph.CapitalB, RogueColor.Magenta), Direction.North, new PatrolBrain((22, 10), (51, 30)), ActorRole.Guard),
                new Actor("Random guard", (5, 23), new GameTile(CP437Glyph.CapitalC, RogueColor.DarkMagenta), Direction.North, new PatrolBrain((5, 23), (5, 38)), ActorRole.Guard),
                new Actor("Another random guard", (1, 42), new GameTile(CP437Glyph.CapitalD, RogueColor.Magenta), Direction.North, new PatrolBrain((1, 42), (19, 58)), ActorRole.Guard),
            };
